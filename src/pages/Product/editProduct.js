...
export default function EditProduct() {
  ...
  React.useEffect(() => {
    setProduct({ type: 'SET_INITIAL_STATE', payload: { ...selectedProduct } });
  }, []);
  ...
  const onSaveProduct = () => {
    reduxDispatch(storeAction.updateProductStore(product));
    ...
    <ProductStyles.Wrapper>
      ...
      <ProductStyles.SubWrapper>
        ...
        <ProductStyles.SaveButtonWrapper>
          <ButtonField title='UPDATE PRODUCT' onClick={onSaveProduct} />
        </ProductStyles.SaveButtonWrapper>
      </ProductStyles.SubWrapper>
    </ProductStyles.Wrapper>
  );
